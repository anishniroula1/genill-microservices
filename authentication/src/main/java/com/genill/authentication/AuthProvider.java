...
public interface AuthProvider {
     ...
     */
    boolean changePassword(String existingPassword, String newPassword, String username);
     ...
     */
    void register(String firstName, String lastName, String userName, String password, String role, String email);
